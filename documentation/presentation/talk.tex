...
% \titlegraphic{\includegraphics[scale=1.25]{image/focuslogo.pdf}} % Optional title page image, comment this line to remove it
...
\section{In the Beginning} % Section title slide, unnumbered
...
\begin{frame}{Columns}
	\begin{columns}
		...
		\column{0.5\textwidth}
			\includegraphics[width=\linewidth]{image/placeholder.jpg}
	\end{columns}
\end{frame}
