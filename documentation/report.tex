...
By the way, if merged commits automatically get deployed then commits are now not just a representation of your application's behavior but also a representation of exactly what your users are seeing. TODO: ref sec on CD
...
We'll do audio analysis on the backend using the Python library librosa.\footnote{TODO}
